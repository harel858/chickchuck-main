        ...
        <MaxWidthWrapper classNames="pb-24 pt-10 flex flex-row-reverse justify-between items-center max-lg:flex-col sm:pb-32 lg:pt-24 xl:pt-32 lg:pb-52 ">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              >
                חבל על הדיבורים{" "}
                <span className="bg-green-600 px-2 text-white">האפליקציה</span>{" "}
                שלך לקביעת תורים
              </h1>
              <p
                style={{ direction: "rtl" }}
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              />
              <Phone className="w-64" imgSrc="/testimonials/screen-shot.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
      ...
      <section className="bg-slate-100 grainy-dark py-24">
        <MaxWidthWrapper classNames="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src="/white-rabbit1.png" className="w-24 order-0 lg:order-2" />
          </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p style={{ direction: "rtl" }}>
                  ...
                  אפשרית. תשלומי המקדמות דרך ביט והתזכורות בווצאפ פשוט מושלמים.
                  הכל במקום אחד!"
                </p>
              </div>
