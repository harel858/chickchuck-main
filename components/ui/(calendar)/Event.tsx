  ...
  return (
    ...
    >
      <motion.li
        ...
        className={`w-full hover:bg-gray-900 bg-white/90 text-black cursor-pointer hover:text-white relative px-16 py-7 border-b border-black/50 flex justify-between`}
      >
        <span
