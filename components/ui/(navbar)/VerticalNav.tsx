...
function VerticalNav({
  ...
  return (
    <nav className="fixed top-0 h-screen w-52 max-2xl:hidden  shadow-sm shadow-black/20 pt-9 gap-10 flex flex-col align-center items-center justify-start bg-gray-600 dark:bg-neutral-700 dark:text-blue-50 border-r border-gray-800 z-50">
      <NavHead user={user} />
